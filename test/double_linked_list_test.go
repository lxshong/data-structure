...
func TestDoubleLinkedListPrint(t *testing.T) {
...
func TestDoubleLinkedListUpdate(t *testing.T) {
	list := src.NewDoubleLinkedList()
	list.Insert(0, 1)
	list.Insert(0, 2)
	list.Insert(1, 3)
...
func TestDoubleLinkedListDelete(t *testing.T) {
	list := src.NewDoubleLinkedList()
	list.Insert(0, 1)
	list.Insert(0, 2)
	list.Insert(1, 3)
